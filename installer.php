...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251023_cesenaintasca_390d4a8a6d6029c96331_20251023074217_archive.zip';
        const ARCHIVE_SIZE       = '52420110';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '390d4a8-23074217';
        const SECONDARY_PACKAGE_HASH = '0a1dc3e-23074217';
